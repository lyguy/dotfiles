...
--- Defer Treesitter setyup after first render to improve startup time onf `nvim {filename}`
...
-- mason-lspconfig requires that these setup function are called in the ordere
